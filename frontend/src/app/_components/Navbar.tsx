        ...
        <div className="hidden lg:flex w-[500px] xl:w-[560px] xl:desktop:w-[500px] justify-between">
          {navLinks.map((navLink, index) => (
            <div
              ...
              } text-xl text-center cursor-pointer desktop:xl:hover:scale-[108%] [transition:font-size_1.2s_cubic-bezier(0,0,1,1),font-weight_1.2s_cubic-bezier(0,0,1,1),transform_.5s_cubic-bezier(0.4,0,0.2,1)]`}
              id={navLink.id}
              key={index}
              onClick={onClickLink}
            >
