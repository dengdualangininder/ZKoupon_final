...
const Instructions = ({
  ...
  return (
    <div className="xs:ml-[28px] sm:ml-[41px] space-y-6 lg:w-[688px]">
      <div className="w-full text-center xs:text-start text-3xl xs:text-2xl font-bold">Instructions</div>
            ...
            {paymentSettingsState.merchantPaymentType === "inperson" ? (
              <div className="flex flex-col relative">
                <div className="flex">
                  ...
                  <div>
                    <span className="font-bold">Enter your business's name</span> under Payment Settings
                  </div>
                </div>
                <div className="mt-4 flex">
                  <div className="mr-2">2.</div>
                  <div>
                    <span className="font-bold">Download your QR code</span> (button located below the shown QR code)
                  </div>
                </div>
                <div className="mt-4 flex">
                  ...
                  <div className="font-bold">
                    ...
                    <div className="ml-2 font-normal">&bull; we recommend using a print shop</div>
                ...
                <div className="mt-4">
                  ...
                  <div className="ml-2 flex">
                    ...
                    <div className="relative">
                      Create an Employee Password below (
      ...
      <div>
        <div className="flex">
          ...
          >
            <div className="text-xl xs:text-lg font-bold">3. Cash out</div>
            <div className="relative mt-[5px] ml-2 w-[20px] h-[20px] rounded-full">
              <div className={`${expandThree ? "rotate-[90deg]" : ""} absolute left-[8.5px] bottom-[3px] w-[2px] h-[12px] bg-blue-600 transition-all duration-500`}></div>
              <div className={`rotate-90 absolute left-[8.5px] bottom-[3px] w-[2px] h-[12px] bg-blue-600`}></div>
            </div>
          </div>
        </div>
