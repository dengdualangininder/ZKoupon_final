      ...
      <div className="detailsModal overflow-y-auto">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "setup" ? setExpand("") : setExpand("setup"))}>
            ...
            <div className={`${expand == "setup" ? "max-h-[500px]" : "max-h-[0px]"} overflow-hidden transition-all duration-[500ms] textBase`}>
              {paymentSettingsState.merchantPaymentType === "inperson" && (
                <div className="">
                  All you have to do is print out and display your QR code so that customers can scan it. In the <span className="font-bold">Cash Out</span> menu, you can download
                  your QR code or email it to a print shop. We recommend a print size of A6 (4x6"), which will fit{" "}
              ...
              {paymentSettingsState.merchantPaymentType === "online" && (
                <div className="flex flex-col space-y-2">
                  <div>
                    Copy your Payment Link in the <span className="font-bold">Cash Out</span> menu and use it in an &lt;a&gt; tag in your HTML code to create a "Pay With MetaMask"
                    button in your checkout page. When a user clicks the button, they will be be able to make payments with MetaMask on desktop or mobile.
                  </div>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "pay" ? setExpand("") : setExpand("pay"))}>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "confirm" ? setExpand("") : setExpand("confirm"))}>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "log" ? setExpand("") : setExpand("log"))}>
            ...
            <div className={`${expand == "log" ? "max-h-[500px]" : "max-h-[0px]"} overflow-hidden transition-all duration-[500ms] textBase`}>
              ...
              logging payments, as all payment details are saved and can be exported in the <span className="font-bold">Payments</span> menu.
            </div>
          </div>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "refund" ? setExpand("") : setExpand("refund"))}>
            ...
            <div className={`${expand == "refund" ? "max-h-[500px]" : "max-h-[0px]"} overflow-hidden transition-all duration-[500ms] textBase space-y-2`}>
              <p>Owners can refund payments by clicking on a transaction, and clicking "Refund Now".</p>
              <p>Due to security, employees are restricted from transferring funds. Therefore, they cannot make refunds.</p>
              <p className="">
                Instead, employees can label a payment as "To Refund". Then, at any time, you (the owner) can go to the <span className="font-bold">Payments</span> menu and refund
                all payments labeled with this tag in a single click.
              </p>
            </div>
          </div>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "cashout" ? setExpand("") : setExpand("cashout"))}>
                ...
                <div className="space-y-2">
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      <div className="mr-1">3.</div>
                      <div>
                        In the <span className="font-bold">Cash Out</span> menu, click the "Transfer to {cashoutSettingsState.cex == "Other CEX" ? "CEX" : cashoutSettingsState.cex}
                        " button and make a transfer
                      </div>
                    </div>
                    <div className="flex">
                      <div className="mr-1">4.</div>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "fees" ? setExpand("") : setExpand("fees"))}>
            ...
            <div className={`${expand == "fees" ? "max-h-[500px]" : "max-h-[0px]"} overflow-hidden transition-all duration-[500ms] textBase`}>
              ...
              account, it will cost ~0.10 USDC. When transferring funds from your {cashoutSettingsState.cex == "Other CEX" ? "CEX" : cashoutSettingsState.cex} account to your bank,{" "}
              {paymentSettingsState.merchantCountry != "Any country" && cashoutSettingsState.cex == "Coinbase"
                ? "there are no fees."
          ...
          <div className={`${paymentSettingsState.merchantCurrency == "USD" ? "hidden" : ""} faqContainer`}>
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "lose" ? setExpand("") : setExpand("lose"))}>
          ...
          <div className="faqContainer">
            {/*--- question ---*/}
            <div className="flex items-center justify-between" onClick={() => (expand == "rate" ? setExpand("") : setExpand("rate"))}>
