...
// components
import FlashToBankAnimation from "./_components/FlashToBankAnimation";
import Placard from "../app/_components/placard/Placard";
// global utils
import ErrorModalLight from "@/utils/components/ErrorModalLight";
import { countryData, countryCurrencyList } from "@/utils/constants";
// images
            ...
            <div className="flex-1 flex flex-col items-center space-y-8">
              ...
              <div className="w-full flex flex-col bg-gray-200 p-4 text-base cursor-pointer rounded-[4px]" onClick={() => setExpand(!expand)}>
                <div className="flex items-center space-x-3">
                  <FaAngleDown className={`${expand ? "rotate-180" : ""} [transition:transform_300ms]`} />
                  <div className="">{t("cashoutCb-2.question")}</div>
                </div>
                <div className={`${expand ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"} grid [transition:opacity_400ms,grid_300ms] overflow-hidden`}>
                  <div className="overflow-hidden">
                    <div className="pt-[8px]">{t("cashoutCb-2.answer")}</div>
                  </div>
                </div>
              </div>
            </div>
